...
`main.go` ships a stub. Add fields to `api/proto/demo-tool/v1/demo-tool.proto`,
...
return &pb.demo-toolResponse{Discovery: discovery, /* + tool-specific fields */}, nil
```
...
```
api/proto/demo-tool/v1/demo-tool.proto      # your contract
...
`api/gen/demo-tool/v1/demo-tool.pb.go`.
